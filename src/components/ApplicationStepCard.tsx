...
export default function ApplicationStepCard({ stepNumber, title, description, timeframe, statusText, statusColor }: Props) {
  return (
    <div
      ...
      className={`p-6 rounded-2xl border flex flex-col sm:flex-row items-start gap-4 transition-all duration-300 relative overflow-hidden ${
        statusColor === 'active' 
    ...
    >
      ...
      <div className="absolute left-6 top-16 bottom-0 w-0.5 bg-white/5 md:block hidden"></div>

      {/* Circle Badge Number */}
      <div className={`w-12 h-12 rounded-full shrink-0 flex items-center justify-center font-mono font-black text-lg ${
        statusColor === 'active' 
      ...
      <div className="flex-1">
        <div className="flex flex-wrap items-center justify-between gap-2 mb-2">
          ...
          <div className="flex items-center gap-2">
            <span className="text-[9px] font-mono text-[#93A4BC] font-semibold">{timeframe}</span>
